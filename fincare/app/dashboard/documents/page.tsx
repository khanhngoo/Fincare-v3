              ...
              <BalanceSheetUploader
                onDataParsed={(data) => {
                  ...
                  if (applicationId && typeof window !== 'undefined') {
                    localStorage.setItem(`financialPerf_${applicationId}`, JSON.stringify(data))
                  }
                  ...
                  toast.success('Balance sheet parsed successfully!', {
                    description: 'Financial data ready for analysis. You can review and edit the data.'
                  })
            ...
            <div className="space-y-4">
              <BankStatementUploader
                onDataParsed={(data) => {
                  ...
                  // Store in localStorage for later analysis
                  if (applicationId && typeof window !== 'undefined') {
                    localStorage.setItem(`bankStatements_${applicationId}`, JSON.stringify(data))
                  }
                  ...
                  toast.success('Bank statement parsed successfully!', {
                    description: `Found ${data.transaction_count || 0} transactions ready for analysis.`
                  })
                  setIsUploadModalOpen(false)
                  setIsManualModalOpen(true)
                }}
